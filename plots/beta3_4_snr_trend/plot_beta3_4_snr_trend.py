"""
Plot tau vs shift_term (SNR proxy) for beta=3.0 and beta=4.0, using only
the reliable SNR levels (shift=1,4,7 -- shift=10,13 could not be reliably
sampled; see SCRIPT_LOG.md in
...
for beta_true in BETAS:
    ...
    ax.errorbar(SHIFTS, taus, yerr=tau_stds, marker="o", markersize=8, capsize=4,
